...
void display()
{
  ...
  //  drawGlass(0,0,0);
  double radius=85;
  drawFilledCircle(450,480,radius);
  drawFilledCircle(250,420,radius);
  drawFilledCircle(650,420,radius);
  drawFilledCircle(100,290,radius);
  drawFilledCircle(800,290,radius);

  //drawing glass
  glPushMatrix();
  glTranslated(100,275,0);
  glScaled(5,5,1);
  drawGlass();
  glPopMatrix();
  //drawing sun
  glPushMatrix();
  glTranslated(250,420,0);
  ...
  //drawing cigarette
  glPushMatrix();
  glTranslated(385,455,0);
  glScaled(2,4,1);
  drawCigs();
  glPopMatrix();
  //drawing fan
  glPushMatrix();
  glTranslated(800,290,0);
  glRotated(-frameNumber*.9,0,0,1);
  glScaled(90,90,1);
  drawFan();
  glPopMatrix();
